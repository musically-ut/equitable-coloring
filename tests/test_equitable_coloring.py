...
from equitable_coloring.utils import make_H_from_C_N
from equitable_coloring.utils import make_N_from_L_C
from equitable_coloring.utils import max_degree
